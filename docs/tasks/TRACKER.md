...
- [ ] Task 1: Universal Document Q&A Workspace 🔄 *(Running - Jules ID: 203415549785961272)* (`docs/tasks/phase-13/task1_universal_doc_qa.md`)
  *Upload any PDF (Contracts, Lab Reports, Blueprints, Papers) and use WebLLM to extract, summarize, or query.*
- [ ] Task 2: Local Directory Semantic Search 🔄 *(Running - Jules ID: 7491966645143974178)* (`docs/tasks/phase-13/task2_directory_search.md`)
