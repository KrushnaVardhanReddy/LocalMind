...
- **[UX]** Task 4: Dynamic Right Inspector Panel ✅ *(Completed - PR #79)* (`docs/tasks/phase-9/task4_inspector.md`)
- **[UX]** Task 5: Workspace Migration ✅ *(Completed - PR #80)* (`docs/tasks/phase-9/task5_migration.md`)
...
- **[Sessions]** Session-4: Session Import — restore from `.lm` file ✅ *(Completed - PR #85)* (`docs/tasks/cross_cutting/task_session4_import.md`)
- **[Docs]** Docs-2: Semantic Search UI in Docs workspace ✅ *(Completed - PR #84)* (`docs/tasks/phase-2/task_docs_search_ui.md`)
...
- **[Plugin]** Task 7: Personal Finance & Tax Workspace ✅ *(Completed - PR #97)* (`docs/tasks/phase-6/task7_finance.md`)
...
- **[Plugin]** Task 1: Universal Document Q&A Workspace 🔄 *(Running)* (`docs/tasks/phase-13/task1_universal_doc_qa.md`)
- **[Plugin]** Task 2: Local Directory Semantic Search 🔄 *(Running)* (`docs/tasks/phase-13/task2_directory_search.md`)
...
- **[Plugins]** Task 7: Personal Finance & Tax Workspace ✅ *(Completed - PR #97)* (`docs/tasks/phase-6/task7_finance.md`)
